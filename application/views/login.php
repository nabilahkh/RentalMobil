          ...
          <div class="row align-items-center position-relative">
            ...
            <div class=" col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                ...
                ?>
                <li><a style="color:white;" href="<?php echo site_url('perawatan/index')?>" class="nav-link">Perawatan</a></li>
                <?php
                }
                ?>
            ...
            <div class="container">
                ...
                <div class="col-lg-4 ml-auto order-lg-1">
                    <div class="mb-2">
                    <h2>Silakan Login Dahulu!</h2>
                    <p>Sebelum melakukan penyewaan, calon customer diharuskan untuk Login terlebih dahulu. Jika belum punya akun, silakan registrasi.</p>
                    </div>
                    ...
                    <?php echo form_open('login/otentikasi')?>
                      ...
                      <div class="form-group row mr-auto">
                        <div class="col-md-3">
                          <input type="submit" class="btn btn-primary text-white py-3 px-5" value="Login"> 
                        </div>
                      </div>
                    <?php echo form_close()?>

                    <form action="<?php echo site_url('register')?>" method="post">
                    <h4>Belum punya akun? silahkan registrasi!</h4></br>
                      <div class="form-group row mr-auto">
                        <div class="col-md-3">
                          <input type="submit" class="btn btn-primary text-white py-3 px-5" value="Registrasi">
                        </div>
                      </div>
                    </form>
